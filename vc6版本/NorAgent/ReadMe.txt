========================================================================
		ActiveX Control DLL : FORMX
========================================================================

ControlWizard has created this project for your FORMX ActiveX Control
...
that make up your FORMX ActiveX Control DLL.
...
FormXCtl.h
	This file contains the declaration of the CFormXCtrl C++ class.

FormXCtl.cpp
	This file contains the implementation of the CFormXCtrl C++ class.

FormXPpg.h
	This file contains the declaration of the CFormXPropPage C++ class.

FormXPpg.cpp
	This file contains the implementation of the CFormXPropPage C++ class.

FormXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CFormXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file NorAgent.rc.
