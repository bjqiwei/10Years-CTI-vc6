...
#define MAX_FAX_CHANNEL_COUNT	62		//最大的FAX通道数
...
public:
	...
	CString m_strSetBusyTime;//坐席set busy 时间
	CString m_strInServerTime;//坐席in server 时间
...
public:
	...
	int  m_nCallType;//呼叫类型：1 Inbound, 0 Outbound ,-1 not any call, 2本地分机间呼叫，3非本地分机间呼叫，跟随呼叫一直到结束
	int  m_nRecordLength;
	...
	CString m_strtBeginTime;//通话开始时间,也就是应答时间
